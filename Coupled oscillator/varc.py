...
import time as time
#parameter
b = -1; a = .5; k = 1; f = .37; w = 1;
m = 100
z = zeros((m,2))
z[:,0] = linspace(0.138,0.139,m)
def cos(x):
  if x != 0:
    xa = abs(x)
    sa = x/xa
...
savetxt('variable coupling constant.dat', z)
print z;
